...
[VolumeComponentMenu("Post-processing Custom/Pixelation")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(PixelationVolumeRendererFeature))]
...
[DisplayInfo(name = "Pixelation")]

// Create the Volume Override by inheriting from VolumeComponent
public sealed class PixelationVolumeVolumeComponent : VolumeComponent, IPostProcessComponent
{
    ...
    public FloatParameter pixelSize = new FloatParameter(640, true);
